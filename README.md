...
> Version: `0.0.10-beta.2` · [View on pub.dev](https://pub.dev/packages/universal_flutter_utils) · [API docs](https://pub.dev/documentation/universal_flutter_utils/latest/)
...
```yaml
dependencies:
  universal_flutter_utils: ^0.0.10-beta.2
```

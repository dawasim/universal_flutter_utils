...
class UFUScreen {
  ...
  static bool get isSmallWidthMobile =>
      isMobile && width < UFUResponsiveDesign.maxSmallMobileWidth;
  ...
  static bool get doForceRefershOnLayoutChange =>
      (isMobile && height > 500) || (isTablet && height > 350);
